...
SRC_FILES_CONV = ft_write_c.c ft_write_s.c ft_write_p.c ft_write_d.c ft_write_i.c ft_write_u.c
...
# Test
TEST_DIR = ./tests
TEST_FILES =  test_write_c.c test_write_s.c test_write_p.c test_write_d.c test_write_i.c test_write_u.c
